      ...
      <header class="bg-wight   ">
        ...
        >
          ...
          <div class="hidden lg:flex lg:gap-x-12">
            ...
            <div className="bg-whatsapp-green text-white font-custom p-4 rounded-lg shadow-xl">
      <h1 className="text-2xl font-semibold mb-4">Hello! Welcome to the admin Dashboard</h1>
