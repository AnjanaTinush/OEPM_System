...
export default function EditExpence({ open, setOpen, productData }) {
  const { register } = useForm();
  const [addTransaction] = api.useAddExpenceMutation();
  const [editProduct] = api.useEditExpenceMutation();
                ...
                <div className="sm:flex sm:items-start">
                  ...
                  <div className="mt-3 sm:mt-0 sm:ml-3 sm:w-1/2">
                    ...
                    <select
                      ...
                      onChange={handleType}
                    >
                      <option value="Tunnel_Construction">
                        Tunnel Construction
                      </option>
                      <option value="Crop_and_Fertilizers">
                        Crop and Fertilizers
                      </option>
                      <option value="Employee_Salaries">
                        Employee Salaries
                      </option>
