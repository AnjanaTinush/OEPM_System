...
function Adminnavbar() {
  ...
  return (
    ...
    <Navbar/>
        ...
        <Link
            to="/e_allusers"
            className={`flex items-center w-full mt-6 py-3 px-4 ${location.pathname === "/e_allusers" ? 'bg-whatsapp-green text-white' : 'hover:bg-whatsapp-green text-green-900'} font-custom rounded-md text-decoration-none mb-2`}
        >
        ...
        <Link
            to="/e_approveleave"
            className={`flex items-center w-full mt-6 py-3 px-4 ${location.pathname === "/e_approveleave" ? 'bg-whatsapp-green text-white' : 'hover:bg-whatsapp-green text-green-900'} font-custom rounded-md text-decoration-none mb-2`}
        >
