  ...
  return (
    ...
    {loading ? (
              ...
              <div className="flex max-w-2xl bg-gray-200 border rounded-3xl px-2 mx-auto mt-16 mr-60">
                <form className="flex items-center w-full" action="leaverequest">
                  <RangePicker
                    format="DD-MM-YYYY"
                  ...
                  <button
                    type="submit"
                    className="bg-white hover:bg-gray-100 text-gray-800 font-light py-0 px-2 border rounded-3xl h-9 shadow"
