    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        const tableHeaders = [
          {
            content: "Name",
            styles: { fillColor: "#48c81b", textColor: "#ffffff" },
          },
          {
            content: "Email",
            styles: { fillColor: "#48c81b", textColor: "#ffffff" },
              ...
              <thead>
                <tr>
                  <div className="flex items-center">
                    ...
                    <button
                      className="text-white bg-whatsapp-green hover:bg-Buttongreen focus:ring-Buttongreen mt-2  p-1 px-10 font-medium rounded-full transition-transform duration-300 ease-in-out transform hover:scale-110"
