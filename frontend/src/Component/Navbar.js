            ...
            {user ? (
              <>
                <div className="hidden lg:flex lg:flex-1 lg:justify-end items-center">
                  <h1 className="text-sm text-whatsapp-green mr-4">{user.name}</h1>
                  <div className="relative inline-block ml-4 mt-0">
                    ...
                    {isOpen && (
                      <div className="absolute right-0 mt-0 flex w-40 flex-col bg-wight-green gap-2 rounded-xl p-2 text-green-900 shadow-xl">
                       <a href="/u_userprofile">  <div class="flex flex-col">
                         
                          <button href="/u_userprofile" class="flex justify-center gap-3 rounded-md py-2 px-3 hover:text-white hover:bg-whatsapp-green no-underline">
